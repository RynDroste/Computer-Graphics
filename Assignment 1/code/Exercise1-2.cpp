...
void sceneDefinition (){
	...
	objects.push_back(new Sphere(1.0, glm::vec3(-0,-2,8), glm::vec3(0.6, 0.9, 0.6))); // Green Sphere

	objects.push_back(new Sphere(1.0, glm::vec3(1.0,-2.0,8.0), glm::vec3(0.6, 0.6, 0.9))); // Blue Sphere
